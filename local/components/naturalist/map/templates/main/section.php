            ...
            <div class="container">
                ...
                <div class="catalog_filter catalog_map">
                            ...
                            <div class="form__item item_name">
                                <div class="field field_autocomplete" data-autocomplete="/ajax/autocomplete.php">
                                    <input type="hidden" data-autocomplete-result
                                           value='<?= ($arResult['SECTION_FILTER_VALUES']["SEARCH"]) ? $arResult['SECTION_FILTER_VALUES']["SEARCH"] : null ?>'>
                                    <label for="field-place"><?= Loc::getMessage('FILTER_PLACE') ?></label>
                                    <input class="field__input" type="text" name="name" placeholder=""
                                           data-autocomplete-field
                                           value='<?= ($arResult['SECTION_FILTER_VALUES']["SEARCH_TEXT"]) ? $arResult['SECTION_FILTER_VALUES']["SEARCH_TEXT"] : null ?>'>
                                    <div class="autocomplete-dropdown-wrap">
                                        <div class="autocomplete-dropdown-search">
                                            <input class="field__input" id="field-place" type="text" name="name"
                                                   placeholder="Регионы или локации" data-autocomplete-field-mobile>
                                        </div>
                                    ...
                                    <div class="form__item">
                                        <div class="field field_icon field_calendar">
                                            ...
                                            <div class="field__input" data-calendar-label="data-calendar-label"
                                                 data-date-from><?= ($arResult['arUriParams']['dateFrom']) ? $arResult['arUriParams']['dateFrom'] : '<span></span>' ?></div>
                                        </div>
                                    </div>
                                    <div class="form__item">
                                        <div class="field field_icon field_calendar">
                                            ...
                                            <div class="field__input" data-calendar-label="data-calendar-label"
                                                 data-date-to><?= ($arResult['arUriParams']['dateTo']) ? $arResult['arUriParams']['dateTo'] : '<span></span>' ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="calendar__navigation">
                                            <div class="calendar__navigation-item calendar__navigation-item_months">
                                                <div class="calendar__navigation-label"
                                                    ...
                                                    <span><?= $arResult['currMonthName'] ?></span></div>
                                                <ul class="list">
                                                    <?
                                                    $k = 0;
                                                    ?>
                                                    <? foreach ($arResult['arDates'][0] as $monthName) : ?>
                                                        <li class="list__item<? if ($k == 0) : ?> list__item_active<? endif; ?>">
                                                            <button data-calendar-year="<?= $arResult['currYear'] ?>"
                                                    ...
                                                    <? foreach ($arResult['arDates'][1] as $key => $monthName) : ?>
                                                        ...
                                                        <li class="list__item">
                                                            <button data-calendar-year="<?= $arResult['nextYear'] ?>"
                                                                    data-calendar-month-select="<?= $k ?>"
                                                                    type="button"><?= $monthName ?></button>
                                                            <? if ($key === 0): ?>
                                            ...
                                            <div class="calendar__navigation-item calendar__navigation-item_years">
                                                <div class="calendar__navigation-label"
                                                     data-calendar-navigation="data-calendar-navigation">
                                                    <span><?= $arResult['currYear'] ?></span></div>
                                                <ul class="list">
                                                    <li class="list__item list__item_active">
                                                        <button data-calendar-year-select="<?= $arResult['currYear'] ?>"
                                                                type="button"><?= $arResult['currYear'] ?></button>
                                                    </li>
                                                    <li class="list__item">
                                                        <button data-calendar-year-select="<?= $arResult['nextYear'] ?>"
                                                                type="button"><?= $arResult['nextYear'] ?></button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="form__item guest">
                                    <div class="field field_icon guests" data-guests="data-guests">
                                        <div class="field__input"
                                             data-guests-control="data-guests-control"><?= $arResult['arUriParams']['guests'] + $arResult['arUriParams']['children'] ?> <?= $arResult['guestsDeclension']->get($arResult['arUriParams']['guests'] + $arResult['arUriParams']['children']) ?></div>
                                                ...
                                                <div class="guests__item">
                                                    ...
                                                    <div class="counter">
                                                        ...
                                                        <input type="text" disabled="disabled"
                                                               ...
                                                               name="guests-adults-count"
                                                               value="<?= $arResult['arUriParams']['guests'] ?>"
                                                               data-min="1">
                                                ...
                                                <div class="guests__item">
                                                    ...
                                                    <div class="counter">
                                                        ...
                                                        <input type="text" disabled="disabled"
                                                               ...
                                                               name="guests-children-count"
                                                               value="<?= $arResult['arUriParams']['children'] ?>"
                                                               data-min="0">
                                                        <button class="counter__plus" type="button"></button>
                                                    </div>
                                                </div>
                    ...
                    <button class="button button-clear"
                            data-filter-reset><?= Loc::getMessage('FILTER_RESET') ?></button>
                </div>
                <div class="catalog_sorter<?= (CSite::InDir('/map') ? ' map' : '') ?>">
                    <div class="filter_btn">
                        <?php if (CSite::InDir('/map')): ?>
                            <a href="/catalog/<?= ($_SERVER['QUERY_STRING'] !== '') ? '?' . $_SERVER['QUERY_STRING'] : ''; ?>"
                               class="button button_primary catalog__map-halfscreen link__to_catalog">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M12.942 2.95796C13.1861 3.20204 13.1861 3.59777 12.942 3.84184L7.50864 9.27518C7.11105 9.67277 7.11105 10.327 7.50864 10.7246L12.942 16.158C13.1861 16.402 13.1861 16.7978 12.942 17.0418C12.6979 17.2859 12.3022 17.2859 12.0581 17.0418L6.62476 11.6085C5.73901 10.7228 5.73901 9.27704 6.62476 8.39129L12.0581 2.95796C12.3022 2.71388 12.6979 2.71388 12.942 2.95796Z"
                                          fill="black"/>
                                </svg>
                                <span>Каталог</span>
                            </a>
                        ...
                        <div class="price-filter__wrap">
                            <a class="button price" href="#">
                                ...
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.6464 12.9799L5.8535 9.18705C5.53852 8.87207 5.7616 8.3335 6.20706 8.3335H13.7928C14.2383 8.3335 14.4614 8.87207 14.1464 9.18705L10.3535 12.9799C10.1582 13.1752 9.84166 13.1752 9.6464 12.9799Z"
                                          fill="black"/>
                                </svg>
                            </a>
                            <div class="price-filter">
                                ...
                                <div class="price-inputs__wrap">
                                    <div class="price-input__wrap">
                                        ...
                                        <input type="text" class="min-price"
                                               data-price-value="<?= $arResult['minPrice'] ?>" name="min-price"
                                               value="<?= $arResult['minPrice'] ?>" size="5">
                                        <span>&nbsp;₽</span>
                                    </div>
                                    <div class="price-input__wrap">
                                        <label for="max-price">до</label>
                                        <input type="text" class="max-price"
                                               data-price-value="<?= $arResult['maxPrice'] ?>" name="max-price"
                                               value="<?= $arResult['maxPrice'] ?>" size="5">
                                        <span>&nbsp;₽</span>
                                    </div>
                                </div>
                                ...
                                <div class="price-filter__controls">
                                    ...
                                    <button class="button button_primary button-accept" data-filter-set>Применить
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="sort__list">
                                <li class="list__item">
                                    <?php if ($arResult['sortBy'] == "popular"): ?>
                                        <span class="list__link" data-sort="popular"
                                              data-type="<?= $arResult['orderReverse'] ?>">
