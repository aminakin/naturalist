...
class Version20250924123416 extends Version
{
    protected $author = "admin2";

    protected $description = "130508 | (1) ЛК / Корректировка уведомления по бронированиям / Изменение шаблонов почтовых событий";
    ...
    public function up()
    {
        ...
        $helper->Event()->updateEventMessageById(55, [
          'MESSAGE' => '<!--[if (mso 16)]>
    <style type="text/css">
...
<div dir="ltr" class="es-wrapper-color" lang="RU" style="background-color:#F6F6F6">
 ...
 <br>'
        ...
        $helper->Event()->updateEventMessageById(75, [
          'MESSAGE' => '<!--[if (mso 16)]>
    <style type="text/css">
    a {text-decoration: none;}
    </style>
