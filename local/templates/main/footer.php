...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer__worktime-phone">
            <? $APPLICATION->IncludeFile("/include/footer/worktime.php"); ?>
        </div>
            ...
            <ul class="list">
                ...
                $APPLICATION->IncludeComponent(
                    ...
                    array(
                        ...
                        "FIELD_CODE" => array("ID"),
                        "PROPERTY_CODE" => array("LINK", "VIEW_FOOTER", 'ICON'),
                        "CHECK_DATES" => "Y",
                        "DETAIL_URL" => "",
        ...
        <div class="footer__politic">
            <? $APPLICATION->IncludeFile("/include/footer/politic.php"); ?>
        </div>
        <? if ($APPLICATION->GetCurPage(false) === '/') : ?>
            ...
            ?>
            <div class="footer__copyright">© <?= $h1SEO; ?>, <?= date("Y"); ?></div>
        <? else : ?>
...
<? if (str_starts_with($APPLICATION->GetCurPage(), '/catalog')): ?>
    </div>
