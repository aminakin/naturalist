...
<style>
	.certs__top-banner {
		background-image: url("<?= CFile::getPath($arResult['PROPERTIES']['BLOCK1_PC_IMG']['VALUE']) ?>");
	}

	.certs__banner2 {
		background-image: url("<?= CFile::getPath($arResult['PROPERTIES']['BLOCK5_PC_IMG']['VALUE']) ?>");
	}

	@media (max-width: 768px) {
		.certs__top-banner {
			background-image: url("<?= CFile::getPath($arResult['PROPERTIES']['BLOCK1_MOB_IMG']['VALUE']) ?>");
		}

		.certs__banner2 {
			background-image: url("<?= CFile::getPath($arResult['PROPERTIES']['BLOCK5_MOB_IMG']['VALUE']) ?>");
		}
	}
</style>
...
<section class="certs__elec">
	<p class="certs__elec-title">
		<?= $arResult['PROPERTIES']['BLOCK2_TITLE']['~VALUE']['TEXT'] ?>
	</p>
	...
	<a href="<?= $arResult['PROPERTIES']['BLOCK2_LINK']['VALUE'] ?>" class="certs__elec-link"><?= $arResult['PROPERTIES']['BLOCK2_LINK_TEXT']['VALUE'] ?></a>
</section>
...
<section class="certs__sliders">
	<div class="sliders__tabs">
		<button type="button" class="button sliders__switcher active" slider="box"><?= $arResult['PROPERTIES']['BLOCK3_TITLE1']['VALUE'] ?></button>
		<button type="button" class="button sliders__switcher" slider="elec"><?= $arResult['PROPERTIES']['BLOCK3_TITLE2']['VALUE'] ?></button>
	</div>
		...
		<div class="sliders__one active" id="box">
			<div class="swiper certs__swiper-one">
				<div class="swiper-wrapper mob-wrap">
					<? foreach ($arResult['PROPERTIES']['BLOCK3_IMG1']['VALUE'] as $img1_key => $img1_value) { ?>
						<div class="swiper-slide">
							<div class="swiper-inner">
								<span class="sliders__slide-title"><?= $arResult['PROPERTIES']['BLOCK3_IMG1']['DESCRIPTION'][$img1_key] ?></span>
								<img width="400" height="365" src="<?= CFile::getPath($img1_value) ?>" alt="">
							</div>
						</div>
					<? } ?>
				</div>
			...
			<p class="sliders__text"><?= $arResult['PROPERTIES']['BLOCK3_TEXT1']['~VALUE']['TEXT'] ?></p>
		</div>
		<div class="sliders__one" id="elec">
			<div class="swiper certs__swiper-two">
				<div class="swiper-wrapper mob-wrap">
					<? foreach ($arResult['PROPERTIES']['BLOCK3_IMG2']['VALUE'] as $img2_value) { ?>
						<div class="swiper-slide">
							<div class="swiper-inner">
								<img width="400" height="365" src="<?= CFile::getPath($img2_value) ?>" alt="">
							</div>
						</div>
					<? } ?>
				</div>
			...
			<p class="sliders__text"><?= $arResult['PROPERTIES']['BLOCK3_TEXT2']['~VALUE']['TEXT'] ?></p>
		</div>
	</div>
	<a href="<?= $arResult['PROPERTIES']['BLOCK3_LINK']['VALUE'] ?>" class="certs__elec-link"><?= $arResult['PROPERTIES']['BLOCK3_LINK_TEXT']['VALUE'] ?></a>
</section>
<section class="certs__video">
	<p class="video__title"><?= $arResult['PROPERTIES']['BLOCK4_TITLE']['VALUE'] ?></p>
	<div class="video__one" id="video">
		<div class="swiper certs__video-slider">
			<div class="swiper-wrapper video-mob-wrap">
				<? foreach ($arResult['PROPERTIES']['BLOCK4_PREVIEW']['VALUE'] as $prKey => $preview) { ?>
					<div class="swiper-slide">
						<a href="<?= CFile::getPath($arResult['PROPERTIES']['BLOCK4_VIDEO']['VALUE'][$prKey]) ?>" class="video__slider-inner fancy" data-fancybox='video-galery' data-caption="<?= $arResult['PROPERTIES']['BLOCK4_TEXT']['VALUE'][$prKey] ?>&lt;br /&gt;<?= $arResult['PROPERTIES']['BLOCK4_TEXT']['DESCRIPTION'][$prKey] ?>">
							<img width="338" src="<?= CFile::getPath($preview) ?>" alt="">
							<span class="video__slide-text">
								<span class="video__slide-name"><?= $arResult['PROPERTIES']['BLOCK4_TEXT']['VALUE'][$prKey] ?></span>
								<span class="video__slide-prof"><?= $arResult['PROPERTIES']['BLOCK4_TEXT']['~DESCRIPTION'][$prKey] ?></span>
							</span>
						</a>
					</div>
				<? } ?>
...
<section class="certs__banner2">
	<div class="certs__banner2-inner">
		...
		<p class="certs__banner2-text2"><?= $arResult['PROPERTIES']['BLOCK5_TITLE']['~VALUE']['TEXT'] ?></p>
		<p class="certs__banner2-text3"><?= $arResult['PROPERTIES']['BLOCK5_SUBTITLE']['~VALUE']['TEXT'] ?></p>
		<a href="<?= $arResult['PROPERTIES']['BLOCK5_LINK']['VALUE'] ?>" class="certs__banner2-link"><?= $arResult['PROPERTIES']['BLOCK5_LINK_TEXT']['VALUE'] ?></a>
	</div>
</section>