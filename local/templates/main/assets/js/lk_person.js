...
var cropper = __webpack_require__(7214);
var cropper_default = /*#__PURE__*/__webpack_require__.n(cropper);
;// CONCATENATED MODULE: ./src/js/components/avatar.js
...
var Avatar = /*#__PURE__*/function () {
  function Avatar() {
    ...
    this.$elements = {
      ...
      dropzone: document.querySelector('[data-dropzone-avatar]'),
      dropzoneField: document.querySelector('[data-dropzone-avatar-value]'),
      crop: document.querySelector('[data-crop-avatar]'),
      save: document.querySelector('[data-avatar-save]')
    };
  }

  _createClass(Avatar, [{
    key: "handleDropzoneDrag",
    value: function handleDropzoneDrag() {
    ...
    value: function handleDropzoneDrop() {
      var _this = this;
      ...
      this.$elements.dropzone.addEventListener('drop', function (event) {
        ...
        if (file.type.includes('image/')) {
          ...
          dt.items.add(file);
          _this.$elements.dropzoneField.files = dt.files;

          _this.$elements.dropzoneField.dispatchEvent(new CustomEvent('change'));
        }
      });
    }
  }, {
    key: "handleDropzoneChange",
    value: function handleDropzoneChange() {
      var _this2 = this;
    ...
    value: function handleClear() {
      this.$elements.avatar.classList.remove('avatar_crop');
      this.$elements.save.disabled = true;
      this.$elements.dropzoneField.value = '';
    }
  }, {
    key: "handleSave",
    value: function handleSave() {
      ...
      this.$elements.save.addEventListener('click', function (event) {
        event.preventDefault();
        window.dispatchEvent(new CustomEvent('saveAvatar', {
          detail: {
            file: _this3.crop.getCroppedCanvas().toDataURL()
          }
        }));
      });
    }
    ...
    value: function init() {
      ...
      var cropOptions = JSON.parse(this.$elements.crop.dataset.cropAvatar) || {};
      this.crop = new (cropper_default())(this.$elements.crop, _objectSpread(_objectSpread({
        viewMode: 1,
        dragMode: 'move',
        rotatable: false,
      ...
      this.handleSave();
      window.addEventListener('modalBeforeClose', function (event) {
        if (event.detail.id === 'photo-edit') _this4.handleClear();
      });
    }
  }]);
