...
exports : 0,  true ?
/* istanbul ignore next */
module : 0, __webpack_require__.amdD);
...
var polyfill = __webpack_require__(7464);
;// CONCATENATED MODULE: ./src/js/vendor/polyfills.js
...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    document.addEventListener('click', function (e) {
      // open by button
      if (e.target.matches(_this.options.modalSelector) || e.target.closest(_this.options.modalSelector)) {
        e.preventDefault();
        var $el = e.target.matches(_this.options.modalSelector) ? e.target : e.target.closest(_this.options.modalSelector);

        _this.open($el.getAttribute('href').substr(1), $el);
      } // close by button


      if (e.target.matches(_this.options.modalCloseSelector) || e.target.closest(_this.options.modalCloseSelector)) {
        e.preventDefault();
...
function _rollupPluginBabelHelpers_b054ecd2_typeof(obj) {
  ...
  return _rollupPluginBabelHelpers_b054ecd2_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
    return typeof obj;
  } : function (obj) {
    return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;
...
function _rollupPluginBabelHelpers_b054ecd2_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function _rollupPluginBabelHelpers_b054ecd2_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function _rollupPluginBabelHelpers_b054ecd2_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) _rollupPluginBabelHelpers_b054ecd2_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) _rollupPluginBabelHelpers_b054ecd2_defineProperties(Constructor, staticProps);
  Object.defineProperty(Constructor, "prototype", {
    writable: false
  });
  return Constructor;
...
function _rollupPluginBabelHelpers_b054ecd2_defineProperty(obj, key, value) {
  if (key in obj) {
    Object.defineProperty(obj, key, {
      value: value,
      enumerable: true,
  ...
  if (typeof Reflect !== "undefined" && Reflect.set) {
    ...
    set = function set(target, property, value, receiver) {
      ...
      if (desc) {
        ...
        _rollupPluginBabelHelpers_b054ecd2_defineProperty(receiver, property, value);
      }
...
function objectIncludes(b, a) {
  ...
  if (a && b && _rollupPluginBabelHelpers_b054ecd2_typeof(a) === 'object' && _rollupPluginBabelHelpers_b054ecd2_typeof(b) === 'object') {
...
var ContinuousTailDetails = /*#__PURE__*/function () {
  ...
  function ContinuousTailDetails() {
    ...
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, ContinuousTailDetails);
...
var PatternInputDefinition = /*#__PURE__*/function () {
  ...
  function PatternInputDefinition(opts) {
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, PatternInputDefinition);
...
var PatternFixedDefinition = /*#__PURE__*/function () {
  ...
  function PatternFixedDefinition(opts) {
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, PatternFixedDefinition);
...
var ChunksTailDetails = /*#__PURE__*/function () {
  ...
  function ChunksTailDetails() {
    ...
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, ChunksTailDetails);
...
var HTMLMaskElement = /*#__PURE__*/function (_MaskElement) {
  ...
  */
  ...
  function HTMLMaskElement(input) {
    ...
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, HTMLMaskElement);
...
var HTMLContenteditableMaskElement = /*#__PURE__*/function (_HTMLMaskElement) {
  ...
  function HTMLContenteditableMaskElement() {
    _rollupPluginBabelHelpers_b054ecd2_classCallCheck(this, HTMLContenteditableMaskElement);

    return _super.apply(this, arguments);
  }

  _rollupPluginBabelHelpers_b054ecd2_createClass(HTMLContenteditableMaskElement, [{
    key: "_unsafeSelectionStart",
    get:
    /**
      Returns HTMLElement selection start
...
;// CONCATENATED MODULE: ./src/js/common/inputmask.js
...
;// CONCATENATED MODULE: ./src/js/common/scroll-to.js

document.addEventListener('click', function (e) {
  if (e.target.matches('[data-scroll-to]') || e.target.closest('[data-scroll-to]')) {
    e.preventDefault();
    var $el = e.target.matches('[data-scroll-to]') ? e.target : e.target.closest('[data-scroll-to]');
...
var Dropdown = /*#__PURE__*/function () {
  ...
  _createClass(Dropdown, [{
    ...
    value: function handleOpen($dropdown) {
      if (!$dropdown.classList.contains(this.classes.opened) && document.querySelector(".".concat(this.classes.opened))) {
        this.handleClose(document.querySelector(".".concat(this.classes.opened)));
      }
        ...
        $item.addEventListener('click', function () {
          ...
          if ($dropdown.dataset.dropdown === 'radio') {
            if (!$item.classList.contains(_this.classes.optionActive)) {
              ...
              var $active = $dropdown.querySelector(".".concat(_this.classes.optionActive));
              if ($active) $active.classList.remove(_this.classes.optionActive);
          ...
          if ($input.value === '' && $label.dataset.dropdownLabel !== '') $label.innerHTML = $label.dataset.dropdownLabel;
        });
      });
    }
  }, {
    ...
    value: function handleBodyHide() {
      ...
      document.addEventListener('click', function (event) {
        if (!event.target.matches('.dropdown') && !event.target.closest('.dropdown')) {
          var dropdownOpened = document.querySelector(".".concat(_this2.classes.opened));
    ...
    value: function handleApply() {
      ...
      document.querySelectorAll('[data-dropdown]').forEach(function ($dropdown) {
        if ($dropdown.dataset.dropdownInit === undefined) {
          $dropdown.querySelector("".concat(_this3.attributes.label)).addEventListener('click', function () {
...
var validate_default = /*#__PURE__*/__webpack_require__.n(validate_js_validate);
;// CONCATENATED MODULE: ./src/js/common/validation.js
  ...
  _createClass(Validation, [{
    ...
    value: function validate($el) {
      ...
      if (errors && $el.dataset.calendar === undefined) {
        $fieldContainer === null || $fieldContainer === void 0 ? void 0 : $fieldContainer.classList.add(this.modifiers.fieldError);
        ...
        if ($errorMessage) {
          ...
          $fieldContainer.insertAdjacentHTML('beforeend', "<span class=\"".concat(this.selectors.formError, "\">").concat(errorText, "</span>"));
        }
      } else {
...
(_document$documentEle = document.documentElement.classList).add.apply(_document$documentEle, htmlClassNames);
/* LAZY LOAD
 * -------------------------------------------------- */
