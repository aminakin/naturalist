...
if (loader) {
  window.addEventListener('load', function () {
    loader.classList.add('clip__loader_show');
  });
}
...
// EXTERNAL MODULE: ./src/js/components/loader.js
var loader = __webpack_require__(2434);
...
;// CONCATENATED MODULE: ./src/js/pages/index.js
...
if ($tabControl) {
  $tabControl.addEventListener('click', function (event) {
    event.target.closest('[data-tab-mobile]').classList.toggle('objects__heading_show');
  });
}
/* CALENDAR
 -------------------------------------------------- */
