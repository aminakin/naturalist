...
(function () {
  ...
  !(function () {
    "use strict"; // CONCATENATED MODULE: ./node_modules/ssr-window/ssr-window.esm.js
    ...
    var dom7_esm = /* unused pure expression or super */ null && dom7_esm_$; // CONCATENATED MODULE: ./node_modules/swiper/shared/dom.js
    ...
    /* harmony default export */
    var dom = dom7_esm_$; // CONCATENATED MODULE: ./node_modules/swiper/shared/utils.js
    ...
    /* harmony default export */
    var core = Swiper; // CONCATENATED MODULE: ./node_modules/swiper/modules/virtual/virtual.js
   ...
   -------------------------------------------------- */
    ...
    var $guestsAdultsCount = document.querySelectorAll(
      "[data-guests-adults-count]"
    );
    var $guestsChildrenCount = document.querySelectorAll(
    ...
    if ($guestsControl) {
      ...
      var countGuests = function countGuests($el) {
        ...
        var $guestsAdultsCountCustom = $parent.querySelector(
          "[data-guests-adults-count]"
        );
        var $guestsChildrenCountCustom = $parent.querySelector(
          "[data-guests-children-count]"
        );

        var allCount =
          parseInt($guestsAdultsCountCustom.value) +
          parseInt($guestsChildrenCountCustom.value);
        $guestsControl.forEach(($guestsControlItem) => {
          $guestsControlItem.innerText = ""
            .concat(allCount, " ")
      ...
      $guestsChildrenCount.forEach(($guestsChildrenCountItem) => {
        $guestsChildrenCountItem.addEventListener("change", function (event) {
          ...
          var $parent = $el.closest(".guests__dropdown");
          var $children = $parent
            .querySelector("[data-guests-children]")
            .querySelectorAll(".guests__item");
          var $guestsChildrenThis = $parent.querySelector(
          ...
          if (value > 0) {
            ...
            if (value > childrenLength) {
              ...
              $guestsChildrenThis.insertAdjacentHTML(
                "beforeend",
                childrenNew
                  .map(function (item) {
                    return (
    ...
    /* harmony default export */
    var l10n_default = english; // CONCATENATED MODULE: ./node_modules/flatpickr/dist/esm/utils/index.js
          ...
          value: function handleChangeMonth() {
            ...
            this.$elements.months.forEach(function ($item) {
              $item.addEventListener("click", function (event) {
                ...
                var calendarIndex = Array.from(
                  _this4.$elements.dropdown
                ).indexOf($parentCalendar);

                _this4.calendar[calendarIndex].changeMonth(
                  nextIndex - _this4.data.month
                );
            ...
            this.$elements.years.forEach(function ($item) {
              $item.addEventListener("click", function (event) {
                ...
                if (!$parent.classList.contains("list__item_active")) {
                  ...
                  _this6.calendar[calendarIndex].changeMonth(
                    nextMonth - _this6.data.month
                  );
    ...
    /* harmony default export */
    var range_calendar = RangeCalendar; // CONCATENATED MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js
    ...
    /* harmony default export */
    var counter = Counter; // CONCATENATED MODULE: ./src/js/components/scroll-lock.js
    ...
    /* harmony default export */
    var device = Device; // CONCATENATED MODULE: ./src/js/helpers/rem_size.js
    function remSize() {
      var size = 10;
                  ...
                  if (response.length) {
                    _this.elements.$dropdown.forEach(($item) => {
                      $item.innerHTML = "\n\t\t\t\t\t\t\t".concat(
                        response
                          .map(function (type) {
                            return '<div class="autocomplete-dropdown__item"><div class="autocomplete-dropdown__title">'
                              .concat(
                                type.type,
        ...
        },
        {
          ...
          value: function init() {
            ...
            document.addEventListener("click", function (event) {
              ...
              if (
                !$el.matches("[data-autocomplete]") &&
                !$el.closest("[data-autocomplete]")
              ) {
                _this2.handleHide();
              }
    ...
    /* harmony default export */
    var search_autocomplete = SearchAutocomplete; // CONCATENATED MODULE: ./src/js/pages/catalog.js
    /* COUNTER
   -------------------------------------------------- */
    // eslint-disable-next-line no-unused-vars
