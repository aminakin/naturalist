...
window.reviewsText = function () {
  document.querySelectorAll('.review__text:not(.review__text_show)').forEach(function ($item) {
    var $container = $item.querySelector('.review__text-container');

    if ($container.clientHeight < $container.querySelector('div').clientHeight) {
      var more = false;
      $item.classList.add('review__text_hide');
      $item.insertAdjacentHTML("beforeend", "<button data-review-more type=\"submit\">".concat(reviewControlText[0], "</button>"));
      ...
      $more.addEventListener('click', function (event) {
        ...
        $more.innerText = $item.classList.contains('review__text_more') ? reviewControlText[1] : reviewControlText[0];
      });
    }
...
var info = __webpack_require__(156);
...
var copy = __webpack_require__(2833);
...
var reviews_text = __webpack_require__(1373);
;// CONCATENATED MODULE: ./src/js/pages/object.js
...
var $gallerySliderContainer = document.querySelector('[data-modal-gallery]');
...
document.addEventListener('click', function (event) {
  ...
  if ($el.matches('[data-review-gallery-item]')) {
    ...
    $gallerySliderContainer.innerHTML = "\n\t\t\t<div class=\"swiper slider-gallery\">\n\t\t\t\t<div class=\"swiper-wrapper\">\n\t\t\t\t\t".concat(JSON.parse($gallery.dataset.reviewGallery).map(function (item) {
      return "<div class=\"swiper-slide\"><img src=\"".concat(item, "\" alt=\"\"></div>");
    }).join(''), "\n\t\t\t\t</div>\n\t\t\t\t<div class=\"swiper-button-prev\">\n\t\t\t\t\t<svg class=\"icon icon_arrow-small\" viewBox=\"0 0 16 16\" style=\"width: 1.6rem; height: 1.6rem;\">\n\t\t\t\t\t\t<use xlink:href=\"#arrow-small\"></use>\n\t\t\t\t\t</svg>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"swiper-button-next\">\n\t\t\t\t\t<svg class=\"icon icon_arrow-small\" viewBox=\"0 0 16 16\" style=\"width: 1.6rem; height: 1.6rem;\">\n\t\t\t\t\t\t<use xlink:href=\"#arrow-small\"></use>\n\t\t\t\t\t</svg>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t");
    gallerySlider = window.modalGallery();
    gallerySlider.slideTo(Array.from($gallery.querySelectorAll('.list__item')).findIndex(function (item) {
      return item === $item;
    }), 0);
...
window.addEventListener('load', function () {
  ...
  if ($textShow && $textShow.clientHeight > 110) {
    ...
    document.querySelector('[data-text-show-control]').addEventListener('click', function (event) {
      event.preventDefault();
      var scrollAfter = 0;
...
if ($servicesHidden.length) {
  ...
  $servicesParent === null || $servicesParent === void 0 ? void 0 : $servicesParent.classList.add('about_hidden-children');
  (_document$querySelect = document.querySelector('[data-services-control]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.addEventListener('click', function (event) {
    event.preventDefault();
    var $el = event.target;
    var scrollAfter = 0;
...
document.addEventListener('click', function (event) {
  ...
  if ($el.dataset.roomMore !== undefined) {
    ...
    $contentModal.insertAdjacentHTML('beforeend', "\n\t\t\t\t\t<div class=\"modal-more\">\n\t\t\t\t\t\t<div class=\"h3 modal-more__title\">".concat(content.title, "</div>\n\t\t\t\t\t\t").concat(content.title ? "<div class=\"modal-more__footnote\">".concat(content.footnote, "</div>") : '', "\n\t\t\t\t\t\t").concat(content.text ? "<div class=\"modal-more__text\">".concat(content.text, "</div>") : '', "\n\t\t\t\t\t\t").concat(content.furnishings.length ? "\n\t\t\t\t\t\t\t\t\t<div class=\"h6\">\u041E\u0441\u043D\u0430\u0449\u0435\u043D\u0438\u0435 \u043D\u043E\u043C\u0435\u0440\u0430</div>\n\t\t\t\t\t\t\t\t\t<ul class=\"list list_circle\">\n\t\t\t\t\t\t\t\t\t\t".concat(content.furnishings.map(function (item) {
      return "<li class=\"list__item\">".concat(item, "</li>");
    }).join(''), "\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t") : '', "\n\t\t\t\t\t\t").concat(content.services.length ? "\n\t\t\t\t\t\t\t\t\t<div class=\"h6\">\u0423\u0441\u043B\u0443\u0433\u0438</div>\n\t\t\t\t\t\t\t\t\t<ul class=\"list list_circle\">\n\t\t\t\t\t\t\t\t\t\t".concat(content.services.map(function (item) {
      return "<li class=\"list__item\">".concat(item, "</li>");
    }).join(''), "\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t") : '', "\n\t\t\t\t\t\t").concat(content.reservCancel.length ? "\n\t\t\t\t\t\t\t\t\t<div class=\"h6\">\u0423\u0441\u043B\u043E\u0432\u0438\u044F \u043E\u0442\u043C\u0435\u043D\u044B \u0431\u0440\u043E\u043D\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u044F</div>\n\t\t\t\t\t\t\t\t\t<ul class=\"list list_circle-small\">\n\t\t\t\t\t\t\t\t\t\t".concat(content.reservCancel.map(function (item) {
      return "<li class=\"list__item\">".concat(item, "</li>");
    }).join(''), "\n\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t") : '', "\n\t\t\t\t\t</div>\n\t\t\t\t"));
